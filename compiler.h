...
#define kMK_FP  MK_FP
#define kFP_SEG FP_SEG
#if defined __WATCOMC__
#define kFP_OFF FP_OFF
#else
#define kFP_OFF(p) ((uint16_t)((uint32_t)(p)))
#define O_BINARY 0
#endif
...
#else
//32-bit
#define kMK_FP(s,o) (void*)((s<<4)+o)
#define kFP_SEG(p)  (((uint32_t)p)>>4)
#define kFP_OFF(p)  (((uint32_t)p)&15)
